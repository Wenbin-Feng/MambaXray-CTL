...
def get_transforms(mode="train", target_size=128):
    ...
    if mode == "train":
        ...
        tranform_list = [
            BrightnessTransform(mu=1, sigma=1, p_per_sample=0.9),
            ...
            #                 border_mode_data="nearest", border_mode_seg="nearest"),
            GaussianBlurTransform(p_per_sample=0.9),
                        ]
        ...
        # 使用 RndTransform 包裹，以便对同一张图像生成两个不同的增强版本
        return TwoCropTransform(transform_1)
